...
// This class is used to interact with the firestore database and cloud firestore database  and it contains methods for interacting with the firestore database/cloud firestore
